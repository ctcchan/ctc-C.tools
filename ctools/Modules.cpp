...
void Modules::fillDisplay(char sym, int num) {    // fill the display with user-defined characters
    cout << "\n" << setfill(sym) << setw(num) << "\n";
}

void Modules::newLines(char out, ofstream &outFile) {
    cout << endl << endl;
    if (out == 'y')
        outFile << endl << endl;
}

void Modules::heading() { // print out the program's heading
    fillDisplay('=', 61);
...
void Modules::menu() {    // print out the menu of programs
...
void Modules::programHeading(string program, int filling, char out, ofstream &outFile, string addString) { // print out the heading of the program
    fillDisplay('*', filling);
...
void Modules::programHeading(int s, int r, int d, int arrSize, int arrSize2, int r1[50], int r2[50], char out, ofstream &outFile, string addString) {
...
void Modules::programHeading(int arrSize, int r[50], char out, ofstream &outFile) {  // overloaded function to print out prime set's heading
    fillDisplay('*', 14);
...
void Modules::primeReference() {  // reference to Larry Solomon's web site
